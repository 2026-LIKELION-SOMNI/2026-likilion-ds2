...
const VARIANT_STYLES: Record<ButtonVariant, string> = {
  primary:
    "flex h-[54px] w-full items-center justify-center rounded-[14px] bg-[#61DBB8] font-sans text-[14px] font-bold text-[#07100D] transition-colors disabled:bg-[#27423C] disabled:text-[#6B8580]",
